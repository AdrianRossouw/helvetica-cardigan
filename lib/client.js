...
function addCreateUI(fridge) {
    ...
    $('body').append('<a href="http://nodeknockout.com/teams/nodesque" class="word back">Helvetica Cardigan</a>')
}

function addShareUI(fridge) {
    shareFridgeView = new ShareFridgeView({model: fridge});
    $('body').append(shareFridgeView.render().el);
    $('body').append('<a href="http://nodesque.nko3.jit.su/" class="word back">&larr;</a>')
}
